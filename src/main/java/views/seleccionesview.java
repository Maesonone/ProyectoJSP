...
public class seleccionesview{
    LoggedUser user = null;

    public seleccionesview(LoggedUser user){
        this.user = user;
    }
    ...
    String url = "jdbc:mysql://localhost:3306/trabajojsp";
        ...
        public String toString() {
            try {
                ArrayList<equipos> a = gservice.requestAll("selecciones", "record");
                ...
                for (equipos equipo : a) {
                    contenidoTabla.append("<tr class=\"fila-tabla\">")
                                ...
                                .append("<td><a href=\"modificar.jsp?id="+equipo.getid()+"&tabla=selecciones\" class=\"btn btn-secondary\">Modificar</a> <a href=\"eliminar.jsp?id="+equipo.getid()+"&tabla=selecciones\" class=\"btn btn-secondary\">Eliminar</a></td>")
                                .append("</tr>");
                }
                ...
                return String.format((new HeaderView(user))+
                                    ...
                                    "</div>" +
                                    "<div class=\"container\">" + 
                                    "   <a href=\"crear.jsp?tabla=selecciones\" class=\"btn btn-primary\">Crear</a>"+ 
                                    "</div>" +
