...
public class esteview{
    LoggedUser user = null;

    public esteview(LoggedUser user){
        this.user = user;
    }
    ...
    String url = "jdbc:mysql://localhost:3306/trabajojsp";
        ...
        public String toString() {
            try {
                ArrayList<equipos> a = gservice.requestAll("este", "record");
                ...
                for (equipos equipo : a) {
                    contenidoTabla.append("<tr class=\"fila-tabla\">")
                                ...
                                .append("<td><a href=\"modificar.jsp?id="+equipo.getid()+"&tabla=este\" class=\"btn btn-secondary\">Modificar</a> <a href=\"eliminar.jsp?id="+equipo.getid()+"&tabla=este\" class=\"btn btn-secondary\">Eliminar</a></td>")
                                .append("</tr>");
                }
                ...
                return String.format((new HeaderView(user))+
                                    ...
                                    "</div>" +
                                    "<div class=\"container\">" + 
                                    "   <a href=\"crear.jsp?tabla=este\" class=\"btn btn-primary\">Crear</a>"+ 
                                    "</div>" +
